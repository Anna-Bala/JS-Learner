...
const L5DataTypesAndFunctions: TLevel = {
  ...
  description: `Return statements are used inside functions. Functions usually do some work and then give back a result. This result is called the return value, and it's sent back to wherever the function was invoked from. When JavaScript hits a return statement inside a function, it stops running the code in that function right there.\n\nYour challenge is to:`,
...
const L11DataTypesAndFunctions: TLevel = {
  ...
  scriptSlots: [
    ...
    ['const filteredArray = ', '', '.filter(filterBinary)', ';'],
  ],
  challangeQuestions: [
    {
